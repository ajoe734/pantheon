...
- `tmpdir=$(mktemp -d /tmp/front-kw03-review-XXXXXX) && git -C ../front-ai-trading-system worktree add --detach "$tmpdir" 6321613cff3c49b11a7619e0f9170217a27a7b17 && ln -s /home/edna/code/front-ai-trading-system/node_modules "$tmpdir/node_modules" && (cd "$tmpdir" && npm run build) && git -C ../front-ai-trading-system worktree remove "$tmpdir" --force`
- `python3 -m pytest -q services/control-plane/bff/test_kw03_evidence_refs_contract.py`
