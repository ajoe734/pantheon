...
- `tmpdir=$(mktemp -d /tmp/front-cw03-review-XXXXXX) && git -C ../front-ai-trading-system worktree add --detach "$tmpdir" 29c985f5b1341513f9bf543d328fb1744327a246 && ln -s /home/lupin/code/front-ai-trading-system/node_modules "$tmpdir/node_modules" && (cd "$tmpdir" && npm run build) && git -C ../front-ai-trading-system worktree remove "$tmpdir" --force`
