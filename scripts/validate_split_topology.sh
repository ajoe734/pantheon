...
for key in BROKER_API_KEY BROKER_API_SECRET EXCHANGE_API_KEY EXCHANGE_API_SECRET SHIOAJI_API_KEY SHIOAJI_SECRET_KEY KRAKEN_API_KEY KRAKEN_API_SECRET FINMIND_API_TOKEN TEJ_API_KEY; do
