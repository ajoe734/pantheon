...
# Dev credentials keep distinct subjects and roles, without claiming MFA.
# Genuine second-factor policies are separate from this password-only login.
...
ssh_bash() {
  ...
  command_prefix+=" AGORA_PRIVATE_CONTENT_DEV_KEK=$(shell_quote "${DEV_AGORA_PRIVATE_CONTENT_DEV_KEK:-}")"
