...
def test_coordinates_exact_gate_then_exact_deploy_on_dev() -> None:
    ...
    # The gate workflow derives PANTHEON_AGORA_CONTRACT_REF from bff_sha;
    # retaining the removed legacy input causes GitHub workflow_dispatch to
    # reject the transaction with HTTP 422.
