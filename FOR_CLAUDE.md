...
AI_NAME=Claude REVIEW_PR="$PR_NUMBER" REVIEW_HEAD_SHA="$PR_HEAD_SHA" REVIEW_FILE=path/declared-in-task-artifacts/evidence.json bash scripts/ai-status.sh handoff P4-001 Codex "Please review the exact PR head and manifest"
