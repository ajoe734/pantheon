...
_CATALOG_ENTRIES: list[BffActionCatalogEntry] = [
    ...
    BffActionCatalogEntry(
        action_id="EvidenceRefAction",
        entity_type="EvidenceRef",
        endpoint=_FINAL_COMMAND_ENDPOINT,
        risk_level=RiskLevel.LOW,
        requires_approval=False,
        requires_confirm_token=False,
        ...
        cooldown_seconds=0,
        idempotency_required=True,
        required_roles=["operator", "reviewer", "approver", "admin"],
        description="Record an Evidence Operations disposition event such as mark stale, request evidence, create task, assign reviewer, or resolve.",
    ),
    BffActionCatalogEntry(
