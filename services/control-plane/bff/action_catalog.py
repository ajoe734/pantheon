...
_CATALOG_ENTRIES: list[BffActionCatalogEntry] = [
    ...
    BffActionCatalogEntry(
        action_id="SubmitEvolutionReview",
        entity_type="EvolutionProgram",
        endpoint=_FINAL_COMMAND_ENDPOINT,
        risk_level=RiskLevel.MEDIUM,
        requires_approval=False,
        ...
        description="Submit evolution program for formal review (draft -> under_review).",
    ),
    BffActionCatalogEntry(
        action_id="ApproveEvolutionProgram",
        entity_type="EvolutionProgram",
        endpoint=_FINAL_COMMAND_ENDPOINT,
        risk_level=RiskLevel.HIGH,
        requires_approval=True,
        ...
        description="Approve reviewed evolution program to active status (under_review -> active).",
    ),
    BffActionCatalogEntry(
        action_id="PauseEvolutionProgram",
        entity_type="EvolutionProgram",
        endpoint=_FINAL_COMMAND_ENDPOINT,
        risk_level=RiskLevel.MEDIUM,
        requires_approval=False,
        ...
        idempotency_required=True,
        required_roles=["operator", "admin"],
        description="Pause active evolution program (active -> paused; run drain).",
    ),
    BffActionCatalogEntry(
        action_id="ResumeEvolutionProgram",
        entity_type="EvolutionProgram",
        endpoint=_FINAL_COMMAND_ENDPOINT,
        risk_level=RiskLevel.MEDIUM,
        requires_approval=False,
        ...
        idempotency_required=True,
        required_roles=["operator", "admin"],
        description="Resume paused evolution program (paused -> active; schedule attempts).",
    ),
    BffActionCatalogEntry(
        action_id="CompleteEvolutionProgram",
        entity_type="EvolutionProgram",
        endpoint=_FINAL_COMMAND_ENDPOINT,
        risk_level=RiskLevel.HIGH,
        requires_approval=False,
        ...
        idempotency_required=True,
        required_roles=["operator", "admin"],
        description="Complete active evolution program after verifying all runs finished.",
    ),
    BffActionCatalogEntry(
        action_id="RetireEvolutionProgram",
        entity_type="EvolutionProgram",
        endpoint=_FINAL_COMMAND_ENDPOINT,
        risk_level=RiskLevel.HIGH,
        requires_approval=True,
        ...
        idempotency_required=True,
        required_roles=["approver", "admin"],
        description="Retire completed evolution program (completed -> retired; terminal).",
    ),
    BffActionCatalogEntry(
        action_id="StopEvolutionProgram",
        entity_type="EvolutionProgram",
        endpoint=_FINAL_COMMAND_ENDPOINT,
        risk_level=RiskLevel.HIGH,
        requires_approval=False,
        ...
        idempotency_required=True,
        required_roles=["operator", "admin"],
        description="Stop evolution program immediately (active/paused -> paused; cancel runs).",
    ),
    BffActionCatalogEntry(
        action_id="FreezeEvolutionGeneration",
        entity_type="EvolutionProgram",
        endpoint=_FINAL_COMMAND_ENDPOINT,
        risk_level=RiskLevel.HIGH,
        requires_approval=True,
        ...
        idempotency_required=True,
        required_roles=["approver", "admin"],
        description="Freeze evolution program generation to prevent new additions or promotions.",
    ),
    BffActionCatalogEntry(
        action_id="PromoteEvolutionCandidatePaper",
        entity_type="EvolutionProgram",
        endpoint=_FINAL_COMMAND_ENDPOINT,
        risk_level=RiskLevel.HIGH,
        requires_approval=True,
        ...
        idempotency_required=True,
        required_roles=["approver", "admin"],
        description="Promote evolution candidate to paper trading.",
    ),
    BffActionCatalogEntry(
        ...
        idempotency_required=True,
        required_roles=["approver", "admin"],
        description="Promote evolution candidate to live trading (strictly no capital authority).",
    ),
    BffActionCatalogEntry(
