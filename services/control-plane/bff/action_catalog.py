...
_CATALOG_ENTRIES: list[BffActionCatalogEntry] = [
    ...
    BffActionCatalogEntry(
        ...
        idempotency_required=True,
        required_roles=["approver"],
        description="Approve a HumanGate item from the Management human inbox through command admission.",
    ),
    BffActionCatalogEntry(
        ...
        idempotency_required=True,
        required_roles=["approver"],
        description="Reject a HumanGate item from the Management human inbox through command admission.",
    ),
    BffActionCatalogEntry(
    ...
    BffActionCatalogEntry(
        ...
        idempotency_required=True,
        required_roles=["approver"],
        description="Revoke a previously admitted HumanGate decision without mutating live capital.",
    ),
    BffActionCatalogEntry(
