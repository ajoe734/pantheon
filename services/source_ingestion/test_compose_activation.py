...
def test_root_compose_wires_source_ingest_service_boundary() -> None:
    ...
    # Default-on owner is an unbounded, pull-disabled internal reconciler.
    # Explicit bounded deployments override these variables to enable one
    # reviewed provider pull.
