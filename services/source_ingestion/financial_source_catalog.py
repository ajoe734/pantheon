...
INITIAL_FINANCIAL_DATA_SOURCE_ENTRIES: tuple[DataSourceEntry, ...] = (
    ...
    _entry(
        ...
        metadata={
            ...
            "connector_status": "pending_adapter_implementation",
            "not_live_ingestion_claim": True,
        },
    ),
    _entry(
    ...
    _entry(
        data_source_id="ds-yahoo-us-daily-ohlcv",
        ...
        datasets=(
            _dataset(
                ...
                "market_daily",
                storage_tier="raw/normalized/features",
                update_profile="daily_after_close_keyless_chart_api",
                storage_targets=("raw/yahoo/chart", "normalized/us_price_daily", "features/us_returns"),
                universe_tiers=("core_universe", "candidate_universe", "archive_universe"),
                notes="Keyless Yahoo chart API daily OHLCV. Replaces Stooq after runtime anti-bot wall blocked CSV access.",
                metadata={
                    "replaces_connector_id": "us-stooq-daily-ohlcv",
                    "corporate_action_adjustment_policy": "yahoo_adjclose_captured_when_present",
                },
            ),
        ),
        metadata={
            "preferred_role": "keyless_public_us_daily_price_reference",
            "config_template_ids": ["template-us-yahoo-daily-ohlcv"],
            "replaces_connector_id": "us-stooq-daily-ohlcv",
        },
    ),
    _entry(
...
INITIAL_FINANCIAL_DATA_SOURCE_CONFIG_TEMPLATES: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "auth": {"auth_type": "none"},
        "fetch": {
            "mode": "pending_provider_owned_adapter",
            ...
            "adapter_status": "pending_implementation",
            "not_live_ingestion_claim": True,
        },
        "schedule": {
    ...
    {
        "schema_version": FINANCIAL_DATA_SOURCE_CONFIG_TEMPLATE_SCHEMA_VERSION,
        "template_id": "template-us-yahoo-daily-ohlcv",
        "data_source_id": "ds-yahoo-us-daily-ohlcv",
        "connector_id": "us-yahoo-daily-ohlcv",
        "source_type": "market",
        "provider": "Yahoo Finance",
