...
class ApprovalEvidence(BaseModel):
    ...
    def require_valid(self, *, expected: Mapping[str, Any] | None = None,
        ...
        if (self.decision_state != 'decided' or self.decision != 'approved'
            ...
            raise ApprovalInvalid('Approval is not unconditional current owner authority')
        ...
        try:
            ...
            raise ApprovalInvalid('Approval expiry is missing, malformed or elapsed') from exc
