...
- `docs/04/sa_sd_pkt_68abefcfb82f_smoke_management_ai_openclaw_repair_work/` for requirement capture, SA, and SD.
- `docs/02-architecture/sa_sd_pkt_68abefcfb82f_smoke_management_ai_openclaw_repair_work_architecture.md` for the architecture note.
- `docs/05-ui/sa_sd_pkt_68abefcfb82f_smoke_management_ai_openclaw_repair_work_ui.md` for the operator UI flow note.
- `.orchestrator/task-briefs/task_08e9be7e68d0.md` for worker dispatch context.
...
- `pytest services/control-plane/bff/tests/test_req_efb101c347fb.py`
