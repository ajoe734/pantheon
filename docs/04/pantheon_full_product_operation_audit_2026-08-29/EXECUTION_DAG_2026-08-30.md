...
- Frontend Tasks (Repo: `execute_plans`): `OPGAP-FE-BUNDLE-CLEANUP-20260830`, `OPGAP-FE-MGMT-CRUD-POSTMORTEM-20260830`, `OPGAP-FE-AGORA-WORKSHOP-20260830`, `OPGAP-FE-INTEGRATION-ASSEMBLY-20260830`.
...
2. **Agent Capability Lanes**: Every child task has distinct owner and reviewer selected from the active auto-worker agents (`Antigravity`, `Antigravity2`, `Codex`, `Codex2`, `Claude`, `Claude2`) with live config capacity derived dynamically from `.orchestrator/config.json`.
