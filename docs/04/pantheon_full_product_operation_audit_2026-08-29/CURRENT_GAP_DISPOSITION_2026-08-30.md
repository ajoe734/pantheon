...
| `OP-G08` | P1 | `active` | `OPGAP-BFF-MAIN-ASSEMBLY-20260830` | BFF composition cleanup incomplete (`main.py` monolithic 68k lines, 441 decorators). Extract all 441 decorators and handlers into 18 domain routers, reducing `main.py` to pure composition root. [Merged with Finding F21]. |
