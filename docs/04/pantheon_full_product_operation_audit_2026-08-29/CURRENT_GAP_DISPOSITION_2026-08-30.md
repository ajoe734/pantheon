...
5. **Batch B (14) superseded, Batch C (9) never superseded**: because the Batch C packet never reached a prior successful admission, the 9 Batch C task ids materialized directly on their first successful drain — they carry no supersede record and no replacement id (the ledger records this as an identity mapping, not an omission).
