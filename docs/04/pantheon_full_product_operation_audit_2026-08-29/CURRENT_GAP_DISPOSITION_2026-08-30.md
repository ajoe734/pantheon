...
2. **Current Baseline State**:
   - Hosted Pair: Pair ID `9de4cd001a8b7aaf18a1094fb1699ece19f0efd86d3d24994cd9f3562fe33727`, accepted at `2026-08-30T16:17:23Z`, Backend `2bcb4465399af83190c5027073f3b2296e377256`, Frontend `7d30e78476be61222af63a089e7ab141aa43b809`, Status `accepted`.
   - Hosted identity baseline: Served `/deployment.json` and live `/bff/version` both report backend `2bcb4465399af83190c5027073f3b2296e377256` (reconciling previous manifest/runtime drift via run 33319323262 / gate 33320810888); `OP-G03` remains planned for target candidate promotion under `OPGAP-HOSTED-DEV-PROMOTION-20260830` to deploy the unified post-remediation release candidate and verify matching runtime SHA-256 identities.
