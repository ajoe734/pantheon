...
2. **Current Baseline State**:
   - Hosted Pair: Pair ID `3b4c1f0b5a21245c63623583755785c5b9d81288025e6dd2eb33ccc82ccde742`, accepted at `2026-08-30T15:18:26Z`, Backend `92077907540d4554e9b8a1d12e2528505b2d1ebe`, Frontend `7d30e78476be61222af63a089e7ab141aa43b809`, Status `accepted`.
   - Hosted identity baseline: Served `/deployment.json` and live `/bff/version` both report backend `92077907540d4554e9b8a1d12e2528505b2d1ebe` (reconciling previous manifest/runtime drift); `OP-G03` remains planned for target candidate promotion under `OPGAP-HOSTED-DEV-PROMOTION-20260830` to deploy the unified post-remediation release candidate and verify matching runtime SHA-256 identities.
...
| `OP-G03` | P0 | `planned` | `OPGAP-HOSTED-DEV-PROMOTION-20260830` | Current accepted pair 3b4c1f0b... aligned /deployment.json and live /bff/version on 92077907540d4554e9b8a1d12e2528505b2d1ebe; full product operation remediation requires final unified candidate promotion and post-switch identity verification. | Deploy verified atomic pair from current dev lines post-remediation and verify byte-identical SHA-256 in /deployment.json and /bff/version. | `OPGAP-HOSTED-DEV-PROMOTION-20260830` | Deployed /deployment.json and /bff/version match exact target pair SHAs and return identical runtime identities on pantheon-dev. |
