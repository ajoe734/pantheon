...
| 面向 | 觀察值與事實依據 |
|---|---|
| Pantheon source | `origin/dev@1095c55bf42acc91fac18b701cd24ad5b1874438` |
| execute-plans source | `origin/dev@bd03c863e3c2c1c64b9b7797f27cefaf84df17c1` |
| Hosted live pair | FE `bd03c863...` / BFF `e7f010dc...`；strict live、read-only，非 current candidate |
