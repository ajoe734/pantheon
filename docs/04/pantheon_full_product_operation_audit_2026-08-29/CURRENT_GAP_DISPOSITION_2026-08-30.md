...
2. **Current Baseline State**:
   - Hosted Pair: Pair ID `c426db52184193a4063e57e6d8f06b14d8743336db7ab50f06b8325165d5902e`, accepted at `2026-08-30T09:28:54Z`, Backend `d2bca5bc70bfae897e1ef3ca736ad3680a587679`, Frontend `bd03c863e3c2c1c64b9b7797f27cefaf84df17c1`, Status `accepted`.
   - Closed `OP-G03` on 2026-08-30.
...
- Split into two independent acceptance lanes:
  - Agora authentic hosted demo: Assigned to `AGORA-AGC-14-HOSTED-DEMO-AUTHENTIC-V5-20260829` (in `execute-plans`).
...
1. **Task-Board-vs-Git Drift**:
   ...
   - For example, `AGORA-PERSONA-DURABLE-LIST-READBACK-V2-20260830` is recorded as merged on `origin/dev` (`d2bca5bc70bfae897e1ef3ca736ad3680a587679` via PR #5427) and is terminal `done`, unblocking Batch D assembly.
...
2. **Full Test & CI Limitations**:
   ...
   - Incomplete integration environments that skip tests or timeout must be treated as execution failures.
...
| `OP-G03` | P0 | `closed` | `None (Closed)` | Prior to 2026-08-30, FE/BFF releases were split and lacked atomic pair binding. | Closed on 2026-08-30 by verified hosted release pair `c426db52184193a4063e57e6d8f06b14d8743336db7ab50f06b8325165d5902e` (FE `bd03c863e3c2c1c64b9b7797f27cefaf84df17c1` + BFF `d2bca5bc70bfae897e1ef3ca736ad3680a587679`). | `OPGAP-HOSTED-DEV-PROMOTION-20260830` | Deployed `/deployment.json` and `/bff/version` match exact pair SHAs on pantheon-dev. |
...
| `OP-G14` | P1 | `in_progress & planned` | `AGORA-AGC-14-HOSTED-DEMO-AUTHENTIC-V5-20260829 & OPGAP-HOSTED-MGMT-ACCEPTANCE-20260830` | Split into two non-overlapping lanes: Agora demo in execute-plans; Management desktop UI in pantheon. | Reuses active `AGORA-AGC-14-HOSTED-DEMO-AUTHENTIC-V5-20260829` for Agora; materializes `OPGAP-HOSTED-MGMT-ACCEPTANCE-20260830` for Management desktop UI. | `AGORA-AGC-14-HOSTED-DEMO-AUTHENTIC-V5-20260829` & `OPGAP-HOSTED-MGMT-ACCEPTANCE-20260830` | Hosted browser journeys prove authentic Agora workshop demo and Management console routes render with live data. |
