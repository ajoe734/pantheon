...
2. **Current Baseline State**:
   ...
   - Hosted identity baseline: Served `/deployment.json` and live `/bff/version` both report backend source commit `2bcb4465399af83190c5027073f3b2296e377256` (reconciling previous manifest/runtime drift via controller run 33319323262 / gate 33320810888 / deploy run 33321494484); this product BFF runtime is distinct from remote `origin/dev` (`84f7807dbe99166b9096551beeee88bbe4f7b20a`) and the promoted command runtime (`f12e300f4eb2cf38b34c3432658dc8041570d130`). `OP-G03` remains planned for target candidate promotion under `OPGAP-HOSTED-DEV-PROMOTION-20260830` to deploy the unified post-remediation release candidate and verify matching runtime SHA-256 identities.
