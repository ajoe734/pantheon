...
2. **Current Baseline State**:
   - Hosted Pair: Pair ID `fd30ca36a429e4d5ffed736cb88c6c2888dca43f1b7b1f8f08dab8d1ff794002`, accepted at `2026-08-30T12:52:59Z`, Backend `d2bca5bc70bfae897e1ef3ca736ad3680a587679`, Frontend `7d30e78476be61222af63a089e7ab141aa43b809`, Status `accepted`.
   - Hosted identity conflict: Served `/deployment.json` declares BFF `d2bca5bc...` and pair `fd30ca36...` while live `/bff/version` reports `d5c312ef...`; `OP-G03` remains active and unverified, owned by `OPGAP-HOSTED-DEV-PROMOTION-20260830`.
...
| `OP-G03` | P0 | `planned` | `OPGAP-HOSTED-DEV-PROMOTION-20260830` | Served deployment.json declares BFF d2bca5bc70bfae897e1ef3ca736ad3680a587679 and pair fd30ca36... but live /bff/version reports d5c312ef0a4139329d66bda13c7e487248602ed7; exact runtime identity diverges from manifest. | Deploy verified atomic pair from current dev lines and verify byte-identical SHA-256 in /deployment.json and /bff/version. | `OPGAP-HOSTED-DEV-PROMOTION-20260830` | Deployed /deployment.json and /bff/version match exact pair SHAs and return identical runtime identities on pantheon-dev. |
