...
| `OP-G03` | P0 | `closed` | `None (Closed)` | Prior to 2026-08-30, FE/BFF releases were split and lacked atomic pair binding. | Closed on 2026-08-30 by verified hosted release pair `fd30ca36a429e4d5ffed736cb88c6c2888dca43f1b7b1f8f08dab8d1ff794002` (FE `7d30e78476be61222af63a089e7ab141aa43b809` + BFF `d2bca5bc70bfae897e1ef3ca736ad3680a587679`). | `OPGAP-HOSTED-DEV-PROMOTION-20260830` | Deployed `/deployment.json` and `/bff/version` match exact pair SHAs on pantheon-dev. |
