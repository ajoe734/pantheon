...
- Confirmed `GET /api/v1/knowledge/notes` now derives `meta.surfaces.research_note_list` from dataset availability instead of row count at [main.py](/home/edna/code/pantheon/services/control-plane/bff/main.py:7218).
- Verified the empty service-store and empty-filter regressions in [test_kw02_research_notes_contract.py](/home/edna/code/pantheon/services/control-plane/bff/test_kw02_research_notes_contract.py:300) and [test_kw02_research_notes_contract.py](/home/edna/code/pantheon/services/control-plane/bff/test_kw02_research_notes_contract.py:318).
