...
- [services/control-plane/bff/test_kw01_institutional_memory_contract.py](/home/edna/code/pantheon/services/control-plane/bff/test_kw01_institutional_memory_contract.py:214) still locks the KW-01 detail fixture to `"/operator/incidents/inc-2026-04-05-001/review"`.
- [App.tsx](/home/edna/code/front-ai-trading-system/src/App.tsx:141) mounts `/operator/incidents/:incidentId`, [App.tsx](/home/edna/code/front-ai-trading-system/src/App.tsx:143) mounts `/operator/incidents/:incidentId/action`, and [App.tsx](/home/edna/code/front-ai-trading-system/src/App.tsx:144) mounts `/operator/post-incident-review`, but there is no `/operator/incidents/:incidentId/review` alias in the reviewed front route table.
- A local authenticated FastAPI TestClient probe of [main.py](/home/edna/code/pantheon/services/control-plane/bff/main.py:6670) and [main.py](/home/edna/code/pantheon/services/control-plane/bff/main.py:6727) returned:
