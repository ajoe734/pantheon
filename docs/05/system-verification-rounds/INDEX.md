...
| 009 | rw05 artifact-compare field path (1 test) | test asserted root `non_comparable_artifacts`; code emits it under canonical `error.details` | One-line path fix; rw05 7 passed (was 1 fail); code correct, test path stale | shipped -> dev |
