...
| G-06 | Narrow task-focused shell | BASE §4.2; V4 Screen 10; V6 §16F | Verified narrow behavior under 900px breakpoint; contained shell prevents horizontal overflow, and drawers fit viewport. | **match** | - |
...
| PF-07 | Narrow decision-focused Performance view | V6 §16F | Stacks performance metrics and implements tab selectors for Outcomes/Interventions/Strategies to keep decisions reachable. | **match** | - |
...
| SRV-03 | Narrow full-width drawer with contained underlying page | V4 Screen 10; V6 §16F | Drawers occupy 100% viewport width, trap keyboard focus when open, and make underlying layout inert. | **match** | - |
