...
`SUP-L12-MIN-FUNCTION-DAG-RECONCILE-20260808` verifies that none of the old
28 product task IDs has materialized and records this successor program as the
