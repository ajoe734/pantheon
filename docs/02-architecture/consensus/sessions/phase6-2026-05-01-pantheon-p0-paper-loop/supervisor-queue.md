...
| 3 | Create starter draft | Codex | pending | First editable shared draft |
| 4 | Run cited cross-review | Codex2 -> Gemini -> Copilot -> Claude -> Claude2 | pending | One round at a time |
| 5 | Draft consensus packet | Claude | pending | Escalate unresolved semantic conflicts |
