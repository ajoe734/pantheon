...
- `pytest -v scripts/test_dev_environment_lease_deploy_contract.py` (191 passed, including positive and negative contract checks for deploy_compensation environment export and inner rollback variable preservation)
- `pytest -v scripts/test_*deploy*.py` (304 passed across all deploy contract test suites)
