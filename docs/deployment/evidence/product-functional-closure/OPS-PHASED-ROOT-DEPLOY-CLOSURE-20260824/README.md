...
- `pytest -v scripts/test_dev_environment_lease_deploy_contract.py` (194 passed, including positive and negative executable contract checks for mutation-aware deploy_compensation, full environment export, and inner rollback variable preservation)
- `pytest -v scripts/test_*deploy*.py` (307 passed across all deploy contract test suites)
