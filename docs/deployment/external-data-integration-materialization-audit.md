...
| P2-SOURCE-SEARCH-LIVE-CONNECTOR-SMOKE-001 | in_progress | Codex2 | Bounded live/test source connector smoke through SourceRecord/EvidenceBundle, durable search index, and BFF/SearchGateway readback. |
...
| SVC-SOURCE-SEARCH-PROD-HARDENING | Done: production posture, Postgres/object-store enforcement, health/metrics, idempotency, smoke script. | 72 tests plus py_compile and diff check recorded. | Prod posture smoke script exists, but live target stack credential run is not proven. | P2-SOURCE-SEARCH-LIVE-CONNECTOR-SMOKE-001. |
...
| P1-SOURCE-001 | Done: news/social/alpha DB connector expansion with entitlement/PIT/available_time. | 52 source-ingestion tests and 61 evidence/search tests recorded. | No live/test credential connector proof recorded. | P2-SOURCE-SEARCH-LIVE-CONNECTOR-SMOKE-001. |
