...
- Closeout refresh: `origin/dev` / `87e3eb7671b5b235413f8f4fa432b2a4b36ce757`
  after reviewer sidecar PR `#1988`, FE sidecar closeout PR `#1991`, and
  RBAC detail links PR `#1990`; focused checks re-ran clean.
...
| `origin/dev` advanced during packet prep and closeout | Baseline was refreshed to `c1b18d8d` during packet prep, then to `08390874` after reviewer sidecar PR `#1988`, to `a1848321` after FE sidecar closeout PR `#1991`, and finally to `87e3eb76` after RBAC detail links PR `#1990`; the AG-XR v1.2 surfaces did not change in the intervening closeout, FE sidecar, reviewer sidecar, and RBAC commits. | If reviewing after more dev merges, re-run the focused checks below. |
...
PR `#1988`, FE sidecar closeout PR `#1991`, and RBAC detail links PR `#1990`
