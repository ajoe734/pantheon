...
`cc52b0ac3e33a6bb4e3d62d69e1ed7fcede1e111`, then rechecked the finalization
owner commit `289c9d91` that is merged in `origin/dev`, including:
...
Refresh note: the merged finalization owner commit only updates
