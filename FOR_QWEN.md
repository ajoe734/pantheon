...
AI_NAME=Qwen bash scripts/ai-status.sh handoff <task-id> Claude "Ready for review"
AI_NAME=Qwen REVIEW_FILE=path/to/review.md REVIEW_NOTES_ZH="審查通過||回到 owner 收尾" bash scripts/ai-status.sh approve <task-id> "Review approved and returned to the owner for finalization"
