...
AI_NAME=Codex REVIEW_PR="$PR_NUMBER" REVIEW_HEAD_SHA="$PR_HEAD_SHA" REVIEW_FILE=path/declared-in-task-artifacts/evidence.json bash scripts/ai-status.sh handoff P1-001 Gemini "Exact PR head and manifest ready for review"
