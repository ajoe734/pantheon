...
AI_NAME=Copilot REVIEW_PR="$PR_NUMBER" REVIEW_HEAD_SHA="$PR_HEAD_SHA" REVIEW_FILE=path/to/review.md bash scripts/ai-status.sh handoff RS-001 Codex "Exact PR head and manifest are ready for review"
