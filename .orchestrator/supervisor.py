...
from rewrite.review_intent_recovery import (
    REVIEW_INTENT_RECOVERY_TASK_KEY,
    build_review_decision_intent_recovery_receipt,
    review_decision_intent_recovery_is_current,
...
def review_decision_intent_replay_eligible(
    ...
    (``rewrite.review_intent_recovery``) still exactly matches the live
