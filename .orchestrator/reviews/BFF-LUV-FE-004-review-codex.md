...
Owner: Claude2
execute-plans commit reviewed: `dd469df`
Pantheon sidecar artifact commit reviewed: `dc385fc9`
...
Not approved yet. Rev4 closes the newer seam's normalization bug, but the
frontend's public v1 write surface still returns raw backend live receipts for
the same action and confirm-token flows.
