...
- Owner: Claude
- Reviewer: Claude2
- Next: Implementation complete. Added --component bff to deploy_nonprod_vm.sh (BFF-only deploy without paper fleet disruption) and fixed SIGKILL restart cap bypass in paper_fleet_reconciler.py. Please review and approve.
