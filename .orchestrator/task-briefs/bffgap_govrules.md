...
- Owner: Claude
- Reviewer: Codex
- Next: Review approved: governance sub-rules endpoints verified after compose with origin/dev at d5c5fd2e; 22 focused tests, route manifest check, and OpenAPI probe pass. Owner to finalize PR/merge and run live curl if server env is available.
