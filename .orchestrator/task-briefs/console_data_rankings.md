...
- Owner: Claude
- Reviewer: Claude2
- Next: Review approved: BFF rankings read paths correctly wired with service store + overlay merge, projection derives real metric-catalog formulas, 34/34 tests green. Returning to owner Claude for final closeout.
