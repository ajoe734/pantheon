...
- Owner: Claude2
- Reviewer: Codex
- Next: Review approved: verified ffb52cf0 fixes the promotion default URL and failed-fetch poison path; pytest -q services/control-plane/bff/tests/test_project_approvals_regression.py passed 5/5; pytest -q services/control-plane/bff/tests/test_bff_approvals_surface_contract.py services/control-plane/bff/test_read_store_service_clients.py services/control-plane/bff/test_read_store_deployment.py services/promotion/test_service.py passed 20/20. Returning to Claude2 for task-scoped closeout.
