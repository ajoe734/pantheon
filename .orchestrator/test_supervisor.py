...
class WorkerReassignmentTests(unittest.TestCase):
    ...
    def test_same_owner_reviewer_retry_allowed_negative_matrix_and_positive(self) -> None:
        ...
        task = {
            ...
            "reviewer": "Human/Ops",
            "status": "review",
            "last_commit_progress_at": "2026-08-01T01:00:00Z",
        }
        state = {
            "provider_guardrails": {
                "task_failure_streaks": {
        ...
        # 1. Positive case: progress generation advanced, non-terminal failure kind, owner matches target_agent
        self.assertTrue(
        ...
        # 2. Negative: owner != target_agent
        diff_owner_task = dict(task, owner="Claude")
        self.assertFalse(
            supervisor.same_owner_reviewer_retry_allowed(
                config, state, "RETRY-001", "Antigravity", diff_owner_task
            )
        )
        ...
        old_task = dict(task, last_commit_progress_at="2026-08-01T00:20:00Z")
        self.assertFalse(
            supervisor.same_owner_reviewer_retry_allowed(
    ...
    def test_same_owner_reviewer_retry_real_incident_shape_owner_neq_reviewer(self) -> None:
        ...
        task = {
            ...
            "github_review_bridge": {
                "recorded_at": "2026-08-01T01:30:00Z",
                "decision": "reopen",
            },
        }
        state = {
        ...
        # Gate returns True because owner matches target_agent and progress generation advanced
        self.assertTrue(
            supervisor.same_owner_reviewer_retry_allowed(
    ...
    def test_same_owner_reviewer_retry_replay_progress_generation(self) -> None:
        ...
        task = {
            ...
            "reviewer": "Claude",
            "status": "review",
            "last_commit_progress_at": "2026-08-01T02:00:00Z",
        }
        ...
        # Record another failure without updating task last_commit_progress_at -> last_progress_generation updated to gen2
