...
```
Result: 599 pytest tests passed in test_supervisor.py (including cached probe streak guard & reconcile hysteresis skip guard), 18 pytest tests passed in test_explain_dispatch.py (total 617 passed). Rewrite shadow verification passed 16/16 agents with 0 mismatch. `explain_dispatch` ran cleanly.
